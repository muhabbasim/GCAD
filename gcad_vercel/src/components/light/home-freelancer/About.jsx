          ...
          <div className="col-lg-6">
            <div className="left-block mt-100 md-mb50">
              <div className="d-flex align-items-center">
                <div>
                  <div className="info">
                    <h3 className=" main-color fz-50 line-height-1">12</h3>
                    <p className="nowrap">
                      Years of
                      <br /> Experience
                    </p>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="d-flex align-items-center mb-20">
                      ...
                      <div className="ml-20">
                        <p className="fz-14">Matthew Perry</p>
                      </div>
                    </div>
                    <div className="d-flex align-items-center">
                      <div>
                      ...
                      <div className="ml-20">
                        <p className="fz-14">Germany Office 478 Berlin</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="d-flex align-items-center mb-20">
                      ...
                      <div className="ml-20">
                        <p className="fz-14">+1 840 841 25 69</p>
                      </div>
                    </div>
                    <div className="d-flex align-items-center">
                      <div>
                      ...
                      <div className="ml-20">
                        <p className="fz-14">hello@design.com</p>
                      </div>
                    </div>
                  </div>
                </div>
