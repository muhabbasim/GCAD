      ...
      <div className="container">
        <div className="row justify-content-between">
          ...
          <div className="col-lg-5">
            <div className="text">
              <p>
              A Saudi company that provides technical solutions in various fields and supervises its operation, development and presentation to investors to enter as partners in the main company that owns many technical projects ready to enter the market
              </p>
            </div>
            <div className="main-marq o-hidden mt-100">
              <div className="slide-har st1">
                <div className="box">
                  ...
                  <div className="item">
                    <h4 className="d-flex align-items-center">
                      <span>Suport Digital Club</span>
                      <span className="fz-50 ml-50 stroke icon">*</span>
                    </h4>
                  </div>
                  <div className="item">
                    <h4 className="d-flex align-items-center">
                      <span>Veterinary Care Card</span>
                      <span className="fz-50 ml-50 stroke icon">*</span>
                    </h4>
                  </div>
                  <div className="item">
