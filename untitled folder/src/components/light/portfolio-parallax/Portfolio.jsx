            ...
            <div className="col-lg-6 rest">
              <div className="left sticky-item">
                <div
                  ...
                  data-background="/light/assets/imgs/works/stand/1.jpg"
                ></div>
                <div
                  style={{ height: '100vh' }}
                  id="tab-2"
                  className="img bg-img"
                  data-background="/light/assets/imgs/works/stand/2.jpg"
                ></div>
                <div
                  style={{ height: '100vh' }}
                  id="tab-3"
                  className="img bg-img"
                  data-background="/light/assets/imgs/works/stand/3.jpg"
                ></div>
                <div
                  id="tab-4"
                  className="img bg-img"
                  data-background="/light/assets/imgs/works/stand/4.jpg"
                ></div>
                <div
                  id="tab-5"
                  className="img bg-img"
                  data-background="/light/assets/imgs/works/stand/5.jpg"
                ></div>
                <div
                  id="tab-6"
                  className="img bg-img"
                  data-background="/light/assets/imgs/works/stand/6.jpg"
                ></div>
              </div>
            </div>
                ...
                <div className="row">
                  <div className="col-md-9">
                    ...
                    <div className="vew-all mt-50">
                      <a href="/light/project3" className="sub-title">
                        Explore More
                        <span>
                          <svg
                            width="18"
