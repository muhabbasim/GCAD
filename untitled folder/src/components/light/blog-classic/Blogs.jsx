                ...
                <div className="content main-bg">
                  ...
                  <h4 className="mb-15">
                    <a href="/light/blog-details">
                      12 Tips to Leading an Extraordinary Company
                    </a>
                  </h4>
                  <p>
            ...
            <div className="sidebar">
              ...
              <div className="widget catogry">
                ...
                <ul className="rest">
                  <li>
                    <span>
                      <a href="/light/blog-list">Business</a>
                    </span>
                    <span className="ml-auto">33</span>
                  </li>
                  <li>
                    <span>
                      <a href="/light/blog-list">Lifestyle</a>
                    </span>
                    <span className="ml-auto">05</span>
                  </li>
                  <li>
                    <span>
                      <a href="/light/blog-list">Creative</a>
                    </span>
                    <span className="ml-auto">28</span>
                  </li>
                  <li>
                    <span>
                      <a href="/light/blog-list">WordPress</a>
                    </span>
              ...
              <div className="widget last-post-thum">
                ...
                <div className="item d-flex align-items-center">
                  ...
                  <div className="cont">
                    <span className="tag">
                      <a href="/light/blog-list">Web Design</a>
                    </span>
                    <h6>
                      <a href="/light/blog-list">
