              ...
              <ul className="rest">
                <li data-tab="tab-1">
                  <h2 className="fz-80">
                    ...
                    <a href="/light/project1">
                      <span className="text f-bold">Digital Retouch</span>{' '}
                    </a>
                  </h2>
                </li>
                <li data-tab="tab-2">
                ...
                <li data-tab="tab-4">
                  <h2 className="fz-80">
                    ...
                    <a href="/light/project4">
                      <span className="text f-bold">Day Starter</span>
                    </a>
                  </h2>
                </li>
                <li data-tab="tab-5">
                ...
                <li data-tab="tab-9">
                  <h2 className="fz-80">
                    ...
                    <a href="/light/project5">
                      <span className="text f-bold">Avocado Cutter</span>
                    </a>
                  </h2>
                </li>
              </ul>
