            ...
            <div className="content full-width">
              ...
              <div className="row justify-content-end">
                <div className="col-lg-11">
                  <div className="text">
                    <p>
                      A platform that includes services for individuals and companies in the field of artificial intelligence in linking individuals and companies for 
                      employment or training, measuring productivity and building a virtual city for employment
                    </p>
                  </div>
