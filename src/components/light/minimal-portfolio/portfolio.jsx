...
function Portfolio() {
  return (
    <section className="work-minimal section-padding pb-0">
            ...
            <div className="sec-head mb-80">
              <div className="text">
                <h1 className="fz-80">
                  ...
                  <span className="opacity-7 d-block">brands & experience</span>
                </h1>
              </div>
            </div>
          </div>
        </div>
        <div className="gallery2 row stand-marg">
              ...
              <div className="img">
                ...
                <div className="cont d-flex align-items-center">
                  ...
                  <div className="ml-auto">
                    <p>
                      <a href="/ight/portfolio-metro">Graphic Designing</a>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="item mt-40">
              <div className="img">
                ...
                <div className="cont">
                  ...
                  <p>
                    <a href="/ight/portfolio-metro">Graphic Design</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="item mt-40">
              <div className="img">
                ...
                <div className="cont d-flex align-items-center">
                  <div>
                    <h5>
                      <a href="/light/project4">Nice guy with a smile</a>
                    </h5>
                  </div>
                  <div className="ml-auto">
                    <p>
            ...
            <div className="item mt-40">
              <div className="img">
                ...
                <div className="cont d-flex align-items-center">
                  <div>
                    <h5>
                      <a href="/light/project5">Nice guy with a smile</a>
                    </h5>
                  </div>
                  <div className="ml-auto">
                    <p>
