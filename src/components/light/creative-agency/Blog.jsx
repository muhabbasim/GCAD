      ...
      <div className="container">
        <div className="sec-head mb-80">
          ...
          <div className="bord pt-25 bord-thin-top d-flex align-items-center">
            ...
            <div className="ml-auto">
              <a href="/light/blog-list" className="go-more">
        ...
        <div className="item sub-bg2 wow fadeInUp" data-wow-delay=".1s">
          ...
          <div
            ...
            data-background="/light/assets/imgs/blog/blog1.jpg"
            data-overlay-dark="4"
          >
        ...
        <div className="item wow fadeInUp" data-wow-delay=".3s">
          ...
          <div
            className="background bg-img valign text-center"
            data-background="/light/assets/imgs/blog/blog2.jpg"
            data-overlay-dark="4"
          >
            <div className="more ontop full-width">
              <a href="/light/blog-details">
        ...
        <div className="item sub-bg2 wow fadeInUp" data-wow-delay=".5s">
          ...
          <div
            className="background bg-img valign text-center"
            data-background="/light/assets/imgs/blog/blog4.jpg"
            data-overlay-dark="4"
          >
            <div className="more ontop full-width">
              <a href="/light/blog-details">
